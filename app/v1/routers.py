from .endpoints import user_router, project_router, task_router, dashboard_router, personality_test_router, ai_copilot_router
...
# api_router.include_router(ai_copilot_router.router , prefix="/ai_copilot", tags=["AI_copilot"])